...
'VersionDate' : '28-06-2021',                   # fecha version del programa
...
#        tft = st7789.ST7789(vspi, 240, 240,    dc=Pin(cfg['SPI_DC'],Pin.OUT), reset=Pin(cfg['SPI_RES'],Pin.OUT), cs=Pin(cfg['SPI_CS'],Pin.OUT), backlight=Pin(4, Pin.OUT))
        tft = st7789.ST7789(vspi, 240, 240,    dc=Pin(cfg['SPI_DC'],Pin.OUT), reset=Pin(cfg['SPI_RES'],Pin.OUT), backlight=Pin(4, Pin.OUT))
