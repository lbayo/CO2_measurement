...
from machine import Pin, SoftI2C, ADC, reset, unique_id, freq, TouchPad, UART, SoftSPI, TouchPad, time_pulse_us, RTC
...
cfg={
'Version'     :  19.2,                            # version del programa
'VersionDate' : '18-07-2021',                   # fecha version del programa
...
'prefijo'     : 'e-sys/',                             # prefijo  a  todos los topics
...
if WiFi:
    ...
    rtc=RTC() # crear objeto RTC
    t=rtc.datetime() # leer hora del RTC
    print ("\n** UTC clock down")        
    print("** UTC time %2d-%02d-%04d %2d:%02d:%02d" %(t[2],t[1],t[0],t[4],t[5],t[6]))
