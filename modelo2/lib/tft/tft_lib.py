...
fecha0=""; hora0=""; temp0=""; hum0=""; co20=""; tvoc0=""
...
def ini_tft(tft,sensor):
    ...
    #fecha
    #titulos
    text (tft, 'lib/tft/romancs.fnt', "eCO2"              , 90,  2,st7789.color565(  0,255,255))
    text (tft, 'lib/tft/romancs.fnt', "ppm"               ,110,  2,st7789.color565(  0,255,255))
    if sensor=="CCS811":
...
def tft_display(tft,sensor,fecha,hora,temp,hum,co2,tvoc):
    global fecha0, hora0, co20,tvoc0, temp0, hum0
    if fecha!=fecha0:
